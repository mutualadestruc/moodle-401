...
$string['removesubmissionconfirmforstudentwithtimelimit'] = '¿Está seguro de que quiere eliminar la entrega para {$a}? Por favor, observe que esto no reiniciará el tiempo límite del estudiante. Usted puede dar más tiempo añadiendo una excepción de usuario de tiempo límite.';
