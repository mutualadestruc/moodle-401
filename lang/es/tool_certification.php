...
/**
 * Strings for component 'tool_certification', language 'es', version '4.1'.
 *
...
$string['aftercompletionwithrelativedate'] = '{$a} después de completar';
...
$string['allocationdateisonorafter'] = 'Fecha de asignación en o posterior a';
...
$string['allocationwindowenddate'] = 'Fecha de cierre';
$string['allocationwindowenddate_help'] = 'Fecha de cierre para la ventana de asignación';
$string['allocationwindowendedon'] = 'La ventana para la asignación a esta certificación se cerró el {$a}.';
$string['allocationwindowstartdate'] = 'Fecha de inicio';
$string['allocationwindowstartdate_help'] = 'Fecha de inicio de la ventana para la asignación';
$string['allocationwindowstartson'] = 'La ventana para la asignación a esta certificación se abre el {$a}.';
$string['archive'] = 'Archivar';
$string['archived'] = 'Archivada';
$string['archivedcertifications'] = 'Certificaciones archivadas';
$string['archivedconfirmation'] = '¿Estás seguro de archivar la certificación \'{$a}\'? Una certificación archivada deja de estar disponible para gestores o participantes y puede sólo  certification will no longer be available for managers or learners and may only be viewed in historical reports.';
...
$string['calendarduedate'] = 'Fecha de vencimiento para la certificación ({$a})';
